...
import { JobProfileListComponent} from './pages/job-profile-list/job-profile-list.component';
...
const routes: Routes = [
    ...
    { path: 'jobprofiles',  loadChildren: './pages/job-profile-list/job-profile-list.module#JobProfileListModule' , canActivate: [AuthGuard] },
